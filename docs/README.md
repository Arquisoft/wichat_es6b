...
The deployment url is: [https://arquisoft.github.io/wichat_es6b/](https://arquisoft.github.io/wichat_es6b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_es6b/](https://arquisoft.github.io/wichat_es6b/), we need to execute `npm run deploy`.
